...
use PhalApi\Api;
use App\Domain\Warehouse as DomainWarehouse;
...
class Warehouse extends Api 
{
    ...
    {
        $warehouse = new DomainWarehouse();
        return array(
            'warehouse' => $warehouse->getList($this->page, $this->perpage)
        );
    }
    ...
    {
        $warehouse = new DomainWarehouse();
        return $warehouse->delete($this->region_id);
    }
}
