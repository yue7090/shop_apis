...
use PhalApi\Api;
use App\Domain\ProductType as DomainProductType;
...
class ProductType extends Api 
{
    ...
    {
        $productType = new DomainProductType();
        return array(
            'productType' => $productType->getList($this->page, $this->perpage)
        );
    }
    ...
    public function info() 
    {
        ...
        $productType = new DomainProductType();
        return array(
            'productType' => $productType->getInfo($where)
        );
    }
    ...
    {
        $productType = new DomainProductType();
        return $productType->delete($this->cat_id);
    }
}
