...
use PhalApi\Api;
use App\Domain\ProductCategory as DomainProductCategory;
...
class ProductCategory extends Api 
{
    ...
    {
        $productCategory = new DomainProductCategory();
        return array(
            'productCategory' => $productCategory->getList($this->page, $this->perpage)
        );
    }
    ...
    public function info() 
    {
        ...
        $productCategory = new DomainProductCategory();
        return array(
            'productCategory' => $productCategory->getInfo($where)
        );
    }
    ...
    {
        $productCategory = new DomainProductCategory();
        return $productCategory->delete($this->cat_id);
    }
}
